...
export default function SimplePortfolio() {
	return (
		<main className="min-h-screen bg-white pt-12">
			...
			<SkillsSection skills={["Java", "Object-Oriented Programming", "Spring Boot", "Spring Security", "JPA/Hibernate", "SQL", "TypeScript","RESTful APIs", "Git", "Docker", "Python", "PowerShell"]} />
